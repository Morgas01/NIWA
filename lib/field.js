...
(function(µ,SMOD,GMOD,HMOD,SC)
{
	...
	let Field=µ.Class(Worker,{
		constructor:function({path,name=SC.path.basename(path),autoOpen=true,allowCommunication=true,communicationList=[],neighbors=[]}={}) //TODO autostart
		{
			this.mega({
				autoStart:false,
	...
	`				);
		...
		onFeedback(data)
		{
			...
			{
				let {name,method,args,timeout=Field.defaults.TIMEOUT}=data;
